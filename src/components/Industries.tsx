    ...
    return(
        <div className="px-5 pt-5 max-w-custom mx-auto" id="about">
            <div className="flex justify-start items-stretch bg-custom rounded-3xl lg:flex-row flex-col">
                ...
                <div className="flex 2xl:basis-5/12 basis-7/12 p-6">
                    <ul className="2xl:p-12 sm:p-6 p-3 flex flex-row flex-wrap bg-white rounded-3xl 2xl:text-xl sm:text-base text-sm font-semibold">
                        {Businesses.map((business) => 
                            <li className="flex flex-row lg:gap-5 gap-3 sm:py-2 py-1 items-center justify-start basis-1/2 p-1">
                                ...
                                <h1 className="sm:text-base text-sm sm:leading-5 leading-4">{business.title}</h1>
                            </li>
                        )}
                    </ul>
                </div>
