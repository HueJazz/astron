...
const Footer = () => {
    ...
    return (
        <div className="flex flex-col custom-px pt-28 pb-28 mb-1.5 -mt-3 custom-max-w mx-auto">
            <div className="flex flex-row">
                <div className="basis-1/4 flex flex-col">
                    <div className="cursor-pointer -ml-4 w-6/12">
                        <p className="text-8xl font-semibold tracking-tighter scale-75 pb-3">αstron</p>
                    </div>
                    <div className="custom-size self-end w-6/12 -mt-0.5 leading-6">
                        Your state-of-the-art software solutions for global business
                    </div>
                </div>
                <div className='basis-1/4'></div>
                <div className='basis-2/4 flex flex-row content-start justify-between'>
                    {Footers.map((item) => (
                        <div className="basis-1/4 flex flex-col py-2.5 pr-4">
                            <div className="text-xl font-medium mb-6">
                                {item.title}
                            </div>
                            <ul className="custom-size leading-6">
                                {item.items.map((item) => (
                    ...
                    <ul className="basis-1/4 flex flex-col gap-12 py-2.5 items-center">
            ...
            <div className="w-1/4 flex flex-col">
                ...
                <ul className="flex flex-row justify-between pr-6">
